...
;JOS
;version: 3.0/ TS4.5.0 05/07/2025

;  13C detected 1H T1 inversion recovery experiment                       
...
#ifdef X90 
  (p1 pl1 ph3):f1 (0.05u pl12 1u cpds2):f2
#else
                                /*end of C90*/ 
0.05u pl12:f2
1u cpds2:f2
...
;#######################################################
  ...
  10m mc #0 to Start F1QF(vd_list.inc)
