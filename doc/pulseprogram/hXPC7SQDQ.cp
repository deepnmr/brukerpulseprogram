...
;#  PC7 recoupling optimize set l1 to 1 or 2 and POPT on cnst35 +- 5000Hz which is +-10% of rf power				#
;####################################################################################################################
;
;
;$CLASS=SolidsIcon
...
"plw11=plw31*pow(((7*cnst31+cnst35)/(10000)),2)"
...
3 (pul90 pl11 ph11 ipp13 ipp14):f1			;PC7 DQ excitation
...
5 (pul90 ph13):f1												;PC7 DQ reconversion
...
;cnst35 : X PC7 recoupling rf-power correction factor in %
