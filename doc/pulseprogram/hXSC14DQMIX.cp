...
;#  SC14 recoupling optimize POPT on cnst35 +- 5000Hz which is +-10% of rf power									#
;####################################################################################################################
;
;$CLASS=SolidsIcon
;$DIM=1D
...
"plw13=plw0*pow(((cnst20)*4*p0/(1000000)),2)"
define pulse pul180
"pul180=(1s/cnst31)/7"
define pulse pul90
"pul90=pul180/2"
...
if "l0>0"
{
  ...
  (0.5up ph0 pl13):f2 
  (1u cpds4):f2
3 (pul180 pl11 ph7 ipp7):f1			;SC14 DQ reconversion
  (pul180 ph8 ipp8):f1
  lo to 3 times 7
  lo to 3 times l1			 
0.5u do:f2
...
ph7= (degree, 90.0) 0 128.57 257.14 25.71 154.29 282.86 51.43
...
ph8= (degree, 90.0) 0 128.57 257.14 25.71 154.29 282.86 51.43
		180 308.57 77.14 205.71 334.29 102.86 231.43
