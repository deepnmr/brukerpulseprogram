...
;#  PC7 recoupling optimize if needed POPT on cnst35 +- 5000Hz which is +-10% of rf power				#
;####################################################################################################################
;
;$CLASS=SolidsIcon
;$DIM=1D
...
if "l0>0"
{
  ...
  (0.5up ph0 pl13):f2 
  (1u cpds4):f2
3 (pul90 pl11 ph7):f1		;PC7 DQ mixing
  (pul360 ph8 ipp8):f1   
  (pul270 ph7 ipp7):f1
  lo to 3 times 7
  lo to 3 times l1			 
...
ph7 = (degree,90.0) 0.00 51.43 102.86 154.29 205.71 257.14 308.57 
ph8 = (degree,90.0) 180.00 231.43 282.86 334.29 385.71 437.14 488.57 
