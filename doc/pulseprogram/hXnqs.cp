...
;###############################################################
;#                                                             #
;#  H-X Cross Polarization Experiment with dipolar dephasing   #
;#                                                             #
...
;$DIM=1D
;$TYPE=CPMAS
;$SUBTYPE= quaternary C only
;$COMMENT=  dipolar dephasing 
...
;l30     : echo length in integer rotor periods for long dephasing delays d20 
