...
4 (p1 ph4):f1 (p3 pl12 ph1):f2						
  ...
  dtau1	cpds4:f2  					;first  J-evolution period 
  (p1 ph5 pl1):f1
  (p1 ph5):f1
  dtau1 
  (p1 ph6):f1						;DQF
  ...
  (pfilt pl14):f2
  (p1 ph16):f1 (2u cpds2):f2				;observe pulse
  go=3 ph31 
  3m do:f2
  10m mc #0 to 2 F1PH(calph(ph11,+90) & calph(ph15, +90), caldel(d0, +in0))
exit
...
;$Id: cpSARCOSY,v 1.6 2017/02/22 16:58:55 ber Exp $
