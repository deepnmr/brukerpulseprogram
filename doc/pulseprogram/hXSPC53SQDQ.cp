...
;#  SPC53 recoupling optimize set l1 to 1 or 2 and POPT on cnst35 +- 5000Hz which is +-10% of rf power				#
;####################################################################################################################
;
;$CLASS=SolidsIcon
;$DIM=2D
...
3 (pul90 pl11 ph11 ipp13 ipp14):f1	;SPC53 DQ excitation
...
5 (pul90 ph13):f1			;SPC53 DQ reconversion
