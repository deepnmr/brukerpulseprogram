;hNhhC Proton-mixing experiment (TopSpin 3.1)
;
...
;p2 	 : pulse width for C 180 at pl1
;p3 	 : pulse width for H 90 at pl2
;p21	 : pulse width for N 90 at pl21
;p25	 : pulse width for first CP (HN, long: 500-2000 us)	
;p46	 : pulse width for second CP (NH, short: <500 us)
...
;sp42 	 : H HN CP power
;sp43	 : N HN CP power
;sp46	 : H power for second CP (NH)
;sp47	 : N power for second CP (NH)
...
;spnam43 : C ramp use e.g. square.100 for square pulse CP
;spnam46 : H ramp use e.g. ramp.10070 for variable amplitude CP
;spnam47 : C ramp use e.g. square.100 for square pulse CP
...
;#####################################################
  ...
  (p46:sp46 ph4):H  (p46:sp47 ph3):N  
  (lalign  (p21 pl21 ph9):N  (p3  pl2 ph5):H)  	;store  magn. along Z
  
   mixing
  
  (p3 pl2 ph6):H								; read out
  (p48:sp48 ph7):H  (p48:sp49 ph8):C  
...
ph2=  0				; N CP spin lock during first cp
ph3=  0 0 2 2			; N CP spin lock during second cp
...
ph9=  1				; N hard pulse for Z-filter
